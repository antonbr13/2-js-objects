...
user1.name = 'Anton';
user1.pwHash = "antonbr13";
user1.username = "antonbredl"
...
// }
//
// var anton = new MakePerson('anton', 23432, 234239080984237);
// var card = new MakeCard(23423, 3422342, 231);
//
// console.log(anton, card);
//
//
//
// function bindCard(person, creditcard) {
//    var newObj = {};
//    newObj.id = person;
//    newObj.card = creditcard;
//
//    return newObj;
// }
//
//
// console.log(bindCard(anton, card));
